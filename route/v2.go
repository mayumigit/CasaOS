...
import (
	...
	v2Route "github.com/mayumigit/CasaOS/route/v2"
...
func InitV2Router() http.Handler {
	...
	e.Use(middleware.OapiRequestValidatorWithOptions(_swagger, &middleware.Options{
		Skipper: func(c echo.Context) bool {
			...
			headerVals := c.Request().Header[echo.HeaderContentType]
			if len(headerVals) > 0 && strings.Contains(headerVals[0], "multipart/form-data") {
				return true
			}
			return false
		},
